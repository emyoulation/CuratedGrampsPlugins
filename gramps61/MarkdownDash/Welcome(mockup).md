![Gramps downloads](media/GrampsPackagePlus.png)
## ![](gramps:icon:gramps-view:32) Gramps for genealogical research  
...
![](gramps:icon:redshift-status-off:64)
...
![](gramps:icon:dialog-information:64) Learn more about **Gramps** by visiting the [Gramps-Project.org website.](https://gramps-project.org/). Explore the [Reference resources available for Gramps](https://gramps.discourse.group/t/about-the-user-manual-category/2585).
### Who makes Gramps?
...
![Welcome to Gramps!](media/background-homepage-2015.jpg)
...
###  ![](gramps:icon:gramps-gramplet:64) Dashboard View
You are currently reading from the "Dashboard" view, where you can add your own gramplets. You can also add gramplets to any view by adding a sidebar and/or bottombar, and right-clicking to the right of the tab.

![](gramps:icon:gramps-config:24) The Configure... option in the View menu (or clicking the icon in the toolbar) opens the "Gramplet Layout" tab. This allows you to subdivide the dashboard into more or fewer columns. 

![](gramps:icon:document-properties:48) You can also drag the Properties button to reposition the gramplet within this dashboard or click to detach the gramplet to float above Gramps or place on a second monitor.
...
* *Gramps* [primary object](https://gramps-project.org/wiki/index.php/Gramps_Glossary#primary_object) *View* [Categories](https://gramps-project.org/wiki/index.php/Gramps_Glossary#V)
    ![](gramps:icon:gramps-gramplet:22) [Dashboard](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Dashboard_Category)
    ![](gramps:icon:gramps-person:22)  [People](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#People_Category) 
    ![](gramps:icon:gramps-relation:22) [Relationships](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Relationships_Category)
    ![](gramps:icon:gramps-family:22) [Families](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Families_Category) 
    ![](gramps:icon:gramps-pedigree:22) [Charts](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Charts_Category) 
    ![](gramps:icon:gramps-event:22) [Events](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Events_Category) 
    ![](gramps:icon:gramps-place:22) [Places](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Places_Category)
    ![](gramps:icon:gramps-geo:22) [Geography](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Geography_Category) 
    ![](gramps:icon:gramps-source:22) [Sources](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Sources_Category) 
    ![](gramps:icon:gramps-citation:22) [Citations](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Citations_Category) 
    ![](gramps:icon:gramps-repository:22) [Repositories](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Repositories_Category) 
    ![](gramps:icon:gramps-media:22) [Media](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Media_Category) 
    ![](gramps:icon:gramps-notes:22) [Notes](https://gramps-project.org/wiki/index.php?title=Gramps_6.0_Wiki_Manual_-_Categories#Notes_Category) 
    

### Addons and "Gramplets"
![Gramps Addon Plugins Guide](GrampsAddons.png) 
